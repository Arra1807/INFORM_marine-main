...
import sys
sys.path.append('C:/Users/shado/Documents/Master Thesis/INFORM_marine-main_new/INFORM_marine-main/data/echosounder_data')
#from data.echosounder_data.dataloader import GroupedGenerator
from dataloader import GroupedGenerator
